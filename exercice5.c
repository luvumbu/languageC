...
int monMax(int valeurEntre1,int valeurEntre2, int valeurEntre3)
{
    ...
    {
        printf("LA Valeur entre n1 est la plus grande %d",valeurEntre1) ; 
    }

        if(valeurEntre2>valeurEntre1 && valeurEntre1>valeurEntre3)
    {
        printf("LA Valeur entre n2 est la plus grande %d",valeurEntre2) ; 
    }
        if(valeurEntre3>valeurEntre2 && valeurEntre3>valeurEntre1)
    {
        printf("LA Valeur entre n3 est la plus grande %d",valeurEntre3) ; 
    }
